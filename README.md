...
function create:Win(text,logo)
	...
	Logo.Image = "http://www.roblox.com/asset/?id=9059073262"
...
elseif placeId == 7449423635 then
    ...
    if OldWorld then
        ...
        elseif lv == 10 or lv <= 19 then
            ...
            POSMON = CFrame.new(-1402.74609, 98.5633316, 90.6417007, 0.836947978, 0, 0.547282517, -0, 1, -0, -0.547282517, 0, 0.836947978)
        end
    end
end
            ...
            if getgenv().AutoFarm then
                if  game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                    repeat wait()
                        LV()
                        TP2(POSQ)
                    until (POSQ.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 8 or getgenv().AutoFarm == false
                    wait(1.8)
                    Q()
                    ...
                    if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                        ...
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == Mon then 
                                    ...
                                    TP2(v.HumanoidRootPart.CFrame * CFrame.new(0,0,20))
...
page1:Toggle("Auto Farm Candies",false,function (value)
...
page3:Ti("SetSpawnPoint")

page3:Toggle("SetSpawnPoint",false,function (value)
...
page3:Toggle("Auto Haki",false,function (value)

end)

page3:Toggle("Bring Mob",false,function (value)

end)

page3:Ti("Fast Attack")

_G.FastAttcak1 = false
page3:Toggle("Fast Attack [1]",_G.FastAttcak1,function (value)
	_G.FastAttcak1 = value
	spawn(function()
	        game:GetService("RunService").RenderStepped:Connect(function()
	            pcall(function()
	                if _G.FastAttcak1 then
...
local getlable = page5:Label("Auto Buy Abilytys")

page5:Toggle("Auto Abilytys",false,function ()
	while _G.AutoAbilytys do wait()
      local args = {
         [1] = "BuyHaki",
         [2] = "Buso"
      }
...
_G.AutoExp = false
page5:Toggle("Auto X2",_G.AutoExp,function (value)
   _G.AutoExp = value
      spawn(function()
          pcall(function()
              while wait(.1) do
...
page6:Button("Credit Script Mobile",function ()
	setclipboard("SHIFT HUB!#0178")
end)

page6:Button("Credit Script Pc",function ()
	setclipboard("X2WHOROLE#6519")
end)
